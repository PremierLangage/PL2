...
import {
  ExerciseViewerComponentDefinition,
  ExerciseViewerState,
...
@WebComponent(ExerciseViewerComponentDefinition)
export class ExerciseViewerComponent
  implements WebComponentHooks<ExerciseViewerState>, AfterViewInit {
  /**
   ...
   */
  @Input() state!: ExerciseViewerState;
   ...
   */
  onGetState(state: ExerciseViewerState) {
      return state;
  }
