...
import { ExerciceReviewerForm } from "../../resources/forms/components/exercice-reviewer/exercise-reviewer";
...
export declare type ProviderFormTypes = RadioGroupForm | InputBoxForm | CodeEditorForm | FormlyForm | ExerciceReviewerForm;

export declare type ProviderFormKeys = 'radioGroup' | 'inputBox' | 'codeEditor' | 'form' | 'correction';